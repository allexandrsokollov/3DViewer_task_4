...
class ObjReaderTest {
    ...
    public void testParseFaceOne01() {
		...
		Assertions.assertEquals(verticesIndices, new ArrayList<>(List.of(2)));
		Assertions.assertEquals(textureVerticesIndices, new ArrayList<>(List.of(3)));
		Assertions.assertEquals(normalVerticesIndices, new ArrayList<>(List.of(4)));
    }
