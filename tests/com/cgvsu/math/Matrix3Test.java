...
class Matrix3Test {
    ...
    public void addTest() throws Exception {
        ...
        Matrix3 mR = Matrix3.getAdded(m1, m2);
        m1.add(m2);
        Matrix3 mR0 = Matrix3.getAdded(m1, m0);
    ...
    public void multiplyVTest() throws Exception {
        ...
        Vector3f v = Matrix3.getMultiplied(m1, v1);
        assertEquals(vR, v);
        Vector3f v2 = m1.getMultiplied(v1);
        assertEquals(vR, v2);
    ...
    public void multiplyMTest() throws Exception {
        ...
        Matrix3 m3 = Matrix3.getMultiplied(m1, m2);
    ...
    public void multiplyNTest() throws Exception {
        ...
        Matrix3 m3 = Matrix3.getMultiplied(m1, n);
    ...
    public void transMatrixTest() throws Exception {
        ...
        Matrix3 mR1 = Matrix3.getTransposedMatrix(m1);
        Matrix3 mR2 = Matrix3.getTransposedMatrix(m2);
        for (int row = 0; row < 3; row++) {
            for (int col = 0; col < 3; col++) {
