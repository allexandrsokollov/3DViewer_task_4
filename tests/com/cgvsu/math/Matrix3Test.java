...
class Matrix3Test {
    ...
    public void multiplyVTest() throws Exception {
        ...
        Vector3f v = Matrix3.multiply(m1, v1);
        assertEquals(vR, v);
        Vector3f v2 = m1.multiply(v1);
        assertEquals(vR, v2);
    ...
    public void multiplyMTest() throws Exception {
        ...
        Matrix3 m3 = Matrix3.multiply(m1, m2);
    ...
    public void multiplyNTest() throws Exception {
        ...
        Matrix3 m3 = Matrix3.multiply(m1, n);
    ...
    public void transMatrixTest() throws Exception {
        ...
        Matrix3 mR1 = Matrix3.transMatrix(m1);
        Matrix3 mR2 = Matrix3.transMatrix(m2);
        for (int row = 0; row < 3; row++) {
            for (int col = 0; col < 3; col++) {
